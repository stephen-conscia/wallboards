...
const linkGroups = [
  {
    title: "Conscia",
    links: [
      { href: "/wallboards/conscia/dual-overview", label: "Overview" },
      { href: "/wallboards/conscia/agent-activity", label: "Agent Activity" },
      { href: "/wallboards/conscia/queue-summary", label: "Queue Summary" },
    ],
  },
  {
    title: "Direct",
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/wallboards/lnp/queue-summary", label: "Queue Summary" },
    ],
  },
  {
    title: "Global",
